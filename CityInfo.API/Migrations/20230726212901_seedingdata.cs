    ...
    public partial class seedingdata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Descirption", "Name" },
                values: new object[,]
                {
                    { 1, "The most populous city in the United States.", "New York City" },
                    { 2, "The capital of Antwerp Province in the Flemish Region in Belgium", "Antwerp" },
                    { 3, "The capital and most populous city of France", "Paris" }
                });
